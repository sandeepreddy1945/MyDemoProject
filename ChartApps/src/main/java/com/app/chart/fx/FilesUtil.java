...
public class FilesUtil {
	...
	public static final String DASHBOARD_PROJECT_CUSTOMER_IMAGES_FOLDER = DASHBOARD_PROJECT_CUSTOMER_FOLDER + SLASH
			+ "images";
	public static final String DASHBOARD_PROJECT_CUSTOMER_DATA_FILE = DASHBOARD_PROJECT_CUSTOMER_FOLDER + SLASH
	...
	public static void initializeFileSettings() throws IOException {
		checkAndCreateDir(MAIN_APP_PATH, IMAGES_DIR_PATH, HTML_DIR_PATH, PROPS_DIR_PATH, JSON_MSGS_PATH, JS_DIR_PATH,
				...
				DASHBOARD_PROJECT_CUSTOMER_FOLDER, DASHBOARD_PROJECT_CUSTOMER_CSS_FOLDER,
				DASHBOARD_PROJECT_CUSTOMER_JS_FOLDER, DASHBOARD_PROJECT_CUSTOMER_IMAGES_FOLDER);
		...
		checkAndCreateFile(RUN_PROPS_PATH, MANAGER_PROPS_PATH, DASHBOARD_PROPS_PATH, DASHBOARD_CONTENT_DATA,
				DASHBOARD_PROJECT_STATUS_FILE, DASHBOARD_PROJECT_SCROLL_TEXT_FILE,
				DASHBOARD_PROJECT_CUSTOMER_DATA_FILE);
